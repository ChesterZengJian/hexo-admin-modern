...
hexo.extend.filter.register('server_middleware', function (app) {
  console.log("hexo-admin-modern")

  if (passwordProtected) {
    console.log("password=", passwordProtected)
    require('./src/auth')(app, hexo);   // setup authentication, login page, etc.
  }

  // Main routes
  app.use(hexo.config.root + 'admin/', serveStatic(path.join(__dirname, 'build')));
